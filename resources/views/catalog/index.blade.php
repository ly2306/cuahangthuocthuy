                ...
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data" id="myForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control nameCatalog" name="nameCatalog" value="{{ old('nameCatalog') }}">
                        </div>
                    </form>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#myDataTable').DataTable({
            ...
            "ajax": '{{ route('catalog.getDataTable') }}',
            "columns": [
        ...
        $(document).on('click', '.btnAdd', function () {
            $('#myModal').modal('show');
            $('#myForm').attr('action', '{{ route('catalog.store') }}');
            $('.nameCatalog').val('');
        });

        $(document).on('click', '.btnEdit', function () {
            var data = JSON.parse($(this).attr('data'));
            $('#myForm').attr('action', '{{ route('catalog.update') }}' + '/' + data.id);
            $('.nameCatalog').val(data.name);
